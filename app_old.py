...
# Importa models (solo classi, senza logica posizione)
from models import CarState, RaceCar

print("APP: Importata configurazione e models base")
...
# Funzione di posizione (mantiene in app.py per evitare import circolari)
