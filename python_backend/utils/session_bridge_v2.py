...
# TODO: Usare update_section_v2 quando implementato
...
if ENABLE_V2_ENGINE:
    logger.warning("⚠️  session_bridge_v2.py: V2 ENGINE ABILITATO - USARE SOLO PER VALIDAZIONE")
else:
    logger.info("ℹ️  session_bridge_v2.py: V2 ENGINE DISABILITATO - USARE session_bridge.py PER PRODUZIONE")
