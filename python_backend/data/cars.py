"""Registry ufficiale delle vetture 2025.

Questi dati sono la versione promossa del sandbox (`tmp_data/cars_2025.py`) e
forniscono istanze `Auto` pronte per essere associate ai Team ufficiali.
"""
...
def create_car_2025(team_name: str, aero_factor: float, grip_factor: float) -> Auto:
    ...
    return Auto(
        auto_id=f"CAR_{team_name.upper()}",
...
CARS_2025: Dict[str, Auto] = {
    "MCL": create_car_2025("McLaren", 1.0000, 1.0000),
    "RBR": create_car_2025("Red Bull", 1.0032, 1.0028),
    "FER": create_car_2025("Ferrari", 1.0048, 1.0042),
    "MER": create_car_2025("Mercedes", 1.0072, 1.0063),
    "AST": create_car_2025("Aston Martin", 1.0100, 1.0088),
    "ALP": create_car_2025("Alpine", 1.0128, 1.0112),
    "HAAS": create_car_2025("Haas", 1.0164, 1.0144),
    "WIL": create_car_2025("Williams", 1.0192, 1.0168),
    "SAU": create_car_2025("Sauber", 1.0220, 1.0192),
    "RB": create_car_2025("RB", 1.0272, 1.0238),
}
...
def list_cars() -> Dict[str, Auto]:
    return CARS_2025.copy()


__all__ = ["create_car_2025", "get_car", "list_cars", "CARS_2025"]
