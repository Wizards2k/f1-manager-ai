...
def load_circuit_config(
    ...
    tyre_param_raw = _load_json(tyre_param_raw_path) if tyre_param_raw_path and tyre_param_raw_path.exists() else {}
    compounds = tyre_param_raw.get("compounds", {})
    tyre_temp_windows = {}
    ...
    return CircuitConfig(
        ...
        tyre_compound_deltas=tyre_compound_deltas,
