...
def _run_phase(state: QualifyingSessionState, phase: QualifyingPhase, lap_number: int, base_time: float) -> None:
...
def test_qualifying_progression_cutoffs_and_roundtrip():
    ...
    _run_phase(state, QualifyingPhase.Q1, lap_number=1, base_time=90.0)
    ...
    _run_phase(state, QualifyingPhase.Q2, lap_number=2, base_time=80.0)
    ...
    _run_phase(state, QualifyingPhase.Q3, lap_number=3, base_time=70.0)
