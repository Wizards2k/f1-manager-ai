# Tyre calibration – at-1969_spielberg

## Track stats
- avg_heat: 0.714
- avg_bump: 0.000
- total_brake_mj: 8.986
- brake_density_mj_per_km: 2.089

## Compounds
### C1
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [88.57, 123.57, 138.57] |
| temp_window_core_c | [89.14, 101.14, 114.14] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.92 |
| wear_rate_base_pct_per_km | 0.087947 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [88.57, 120.57, 133.57] |
| temp_window_core_c | [87.14, 98.14, 109.14] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.107491 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [86.57, 118.57, 133.57] |
| temp_window_core_c | [84.14, 96.14, 107.14] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.0 |
| wear_rate_base_pct_per_km | 0.127035 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [83.57, 106.57, 118.57] |
| temp_window_core_c | [79.14, 91.14, 99.14] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.06 |
| wear_rate_base_pct_per_km | 0.156351 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [80.57, 100.57, 113.57] |
| temp_window_core_c | [74.14, 87.14, 94.14] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.12 |
| wear_rate_base_pct_per_km | 0.185667 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [78.57, 94.57, 103.57] |
| temp_window_core_c | [69.14, 83.14, 89.14] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.18 |
| wear_rate_base_pct_per_km | 0.214982 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [58.57, 70.57, 83.57] |
| temp_window_core_c | [54.14, 67.14, 74.14] |
| gaussian_sigma_surface_c | 7.5 |
| gaussian_sigma_core_c | 6.5 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.117263 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [38.57, 53.57, 68.57] |
| temp_window_core_c | [34.14, 49.14, 59.14] |
| gaussian_sigma_surface_c | 8.0 |
| gaussian_sigma_core_c | 7.0 |
| base_grip | 0.85 |
| wear_rate_base_pct_per_km | 0.097719 |
