# Tyre calibration – cn-2004_shanghai

## Track stats
- avg_heat: 0.782
- avg_bump: 0.000
- total_brake_mj: 13.354
- brake_density_mj_per_km: 2.488

## Compounds
### C1
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [88.91, 123.91, 138.91] |
| temp_window_core_c | [89.35, 101.35, 114.35] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.92 |
| wear_rate_base_pct_per_km | 0.088438 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [88.91, 120.91, 133.91] |
| temp_window_core_c | [87.35, 98.35, 109.35] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.108091 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [86.91, 118.91, 133.91] |
| temp_window_core_c | [84.35, 96.35, 107.35] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.0 |
| wear_rate_base_pct_per_km | 0.127744 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [83.91, 106.91, 118.91] |
| temp_window_core_c | [79.35, 91.35, 99.35] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.06 |
| wear_rate_base_pct_per_km | 0.157224 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [80.91, 100.91, 113.91] |
| temp_window_core_c | [74.35, 87.35, 94.35] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.12 |
| wear_rate_base_pct_per_km | 0.186703 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [78.91, 94.91, 103.91] |
| temp_window_core_c | [69.35, 83.35, 89.35] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.18 |
| wear_rate_base_pct_per_km | 0.216183 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [58.91, 70.91, 83.91] |
| temp_window_core_c | [54.35, 67.35, 74.35] |
| gaussian_sigma_surface_c | 7.5 |
| gaussian_sigma_core_c | 6.5 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.117918 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [38.91, 53.91, 68.91] |
| temp_window_core_c | [34.35, 49.35, 59.35] |
| gaussian_sigma_surface_c | 8.0 |
| gaussian_sigma_core_c | 7.0 |
| base_grip | 0.85 |
| wear_rate_base_pct_per_km | 0.098265 |
