# Tyre calibration – bh-2002_sakhir

## Track stats
- avg_heat: 0.700
- avg_bump: 0.000
- total_brake_mj: 11.287
- brake_density_mj_per_km: 2.104

## Compounds
### C1
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [88.5, 123.5, 138.5] |
| temp_window_core_c | [89.1, 101.1, 114.1] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.92 |
| wear_rate_base_pct_per_km | 0.087845 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [88.5, 120.5, 133.5] |
| temp_window_core_c | [87.1, 98.1, 109.1] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.107366 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [86.5, 118.5, 133.5] |
| temp_window_core_c | [84.1, 96.1, 107.1] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.0 |
| wear_rate_base_pct_per_km | 0.126887 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [83.5, 106.5, 118.5] |
| temp_window_core_c | [79.1, 91.1, 99.1] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.06 |
| wear_rate_base_pct_per_km | 0.156168 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [80.5, 100.5, 113.5] |
| temp_window_core_c | [74.1, 87.1, 94.1] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.12 |
| wear_rate_base_pct_per_km | 0.18545 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [78.5, 94.5, 103.5] |
| temp_window_core_c | [69.1, 83.1, 89.1] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.18 |
| wear_rate_base_pct_per_km | 0.214731 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [58.5, 70.5, 83.5] |
| temp_window_core_c | [54.1, 67.1, 74.1] |
| gaussian_sigma_surface_c | 7.5 |
| gaussian_sigma_core_c | 6.5 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.117126 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [38.5, 53.5, 68.5] |
| temp_window_core_c | [34.1, 49.1, 59.1] |
| gaussian_sigma_surface_c | 8.0 |
| gaussian_sigma_core_c | 7.0 |
| base_grip | 0.85 |
| wear_rate_base_pct_per_km | 0.097605 |
