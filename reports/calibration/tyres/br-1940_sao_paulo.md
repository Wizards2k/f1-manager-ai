# Tyre calibration – br-1940_sao_paulo

## Track stats
- avg_heat: 0.845
- avg_bump: 0.000
- total_brake_mj: 12.477
- brake_density_mj_per_km: 2.935

## Compounds
### C1
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [89.23, 124.23, 139.23] |
| temp_window_core_c | [89.54, 101.54, 114.54] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.92 |
| wear_rate_base_pct_per_km | 0.088894 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [89.23, 121.23, 134.23] |
| temp_window_core_c | [87.54, 98.54, 109.54] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.108648 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [87.23, 119.23, 134.23] |
| temp_window_core_c | [84.54, 96.54, 107.54] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.0 |
| wear_rate_base_pct_per_km | 0.128402 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [84.23, 107.23, 119.23] |
| temp_window_core_c | [79.54, 91.54, 99.54] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.06 |
| wear_rate_base_pct_per_km | 0.158033 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [81.23, 101.23, 114.23] |
| temp_window_core_c | [74.54, 87.54, 94.54] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.12 |
| wear_rate_base_pct_per_km | 0.187664 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [79.23, 95.23, 104.23] |
| temp_window_core_c | [69.54, 83.54, 89.54] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.18 |
| wear_rate_base_pct_per_km | 0.217295 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [59.23, 71.23, 84.23] |
| temp_window_core_c | [54.54, 67.54, 74.54] |
| gaussian_sigma_surface_c | 7.5 |
| gaussian_sigma_core_c | 6.5 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.118525 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [39.23, 54.23, 69.23] |
| temp_window_core_c | [34.54, 49.54, 59.54] |
| gaussian_sigma_surface_c | 8.0 |
| gaussian_sigma_core_c | 7.0 |
| base_grip | 0.85 |
| wear_rate_base_pct_per_km | 0.098771 |
