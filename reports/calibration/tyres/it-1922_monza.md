# Tyre calibration – it-1922_monza

## Track stats
- avg_heat: 0.819
- avg_bump: 0.000
- total_brake_mj: 16.212
- brake_density_mj_per_km: 2.832

## Compounds
### C1
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [89.1, 124.1, 139.1] |
| temp_window_core_c | [89.46, 101.46, 114.46] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.92 |
| wear_rate_base_pct_per_km | 0.088703 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [89.1, 121.1, 134.1] |
| temp_window_core_c | [87.46, 98.46, 109.46] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.108415 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [87.1, 119.1, 134.1] |
| temp_window_core_c | [84.46, 96.46, 107.46] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.0 |
| wear_rate_base_pct_per_km | 0.128127 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [84.1, 107.1, 119.1] |
| temp_window_core_c | [79.46, 91.46, 99.46] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.06 |
| wear_rate_base_pct_per_km | 0.157695 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [81.1, 101.1, 114.1] |
| temp_window_core_c | [74.46, 87.46, 94.46] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.12 |
| wear_rate_base_pct_per_km | 0.187262 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [79.1, 95.1, 104.1] |
| temp_window_core_c | [69.46, 83.46, 89.46] |
| gaussian_sigma_surface_c | 7.0 |
| gaussian_sigma_core_c | 6.0 |
| base_grip | 1.18 |
| wear_rate_base_pct_per_km | 0.21683 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [59.1, 71.1, 84.1] |
| temp_window_core_c | [54.46, 67.46, 74.46] |
| gaussian_sigma_surface_c | 7.5 |
| gaussian_sigma_core_c | 6.5 |
| base_grip | 0.95 |
| wear_rate_base_pct_per_km | 0.118271 |
...
| Parametro | Valore |
|-----------|--------|
| temp_window_surface_c | [39.1, 54.1, 69.1] |
| temp_window_core_c | [34.46, 49.46, 59.46] |
| gaussian_sigma_surface_c | 8.0 |
| gaussian_sigma_core_c | 7.0 |
| base_grip | 0.85 |
| wear_rate_base_pct_per_km | 0.098559 |
